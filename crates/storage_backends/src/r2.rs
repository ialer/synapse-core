...
/// - 区域固定为 "auto"
///
/// This is a thin wrapper around [`OpendalBackend`] (configured with copy+delete
/// rename since R2 doesn't support native rename).
...
impl R2Backend {
    ...
    pub fn new(
        ...
        Ok(Self {
            inner: OpendalBackend::with_copy_delete_rename(op, "R2"),
            endpoint,
